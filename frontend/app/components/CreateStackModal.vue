...
// Shared by both file-driven modes (wireops_file and compose_embedded) —
// which endpoint backs them is picked by creationMode in loadWireopsFiles /
// the selectedWireopsFile watcher below.
