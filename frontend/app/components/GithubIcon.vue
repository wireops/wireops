...
// Source asset: app/assets/img/icons/integrations/github.svg (selfhst/icons,
// github-light.svg/github-dark.svg merged into one currentColor path so
// Tailwind can theme it — white on dark, dark gray on light — instead of
// swapping between two separate CDN images.
...
<template>
  <svg
    ...
    viewBox="0 0 512 512"
    :class="props.iconClass || 'w-5 h-5 text-gray-700 dark:text-white'"
    aria-hidden="true"
  >
    <path
      fill="currentColor"
