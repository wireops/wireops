...
<template>
  <code class="inline-flex items-center gap-1.5 font-mono text-xs px-2 py-1 rounded bg-gray-100 dark:bg-carbon-800 text-gray-900 dark:text-wire-200 border border-gray-300 dark:border-carbon-700/60 break-all">
