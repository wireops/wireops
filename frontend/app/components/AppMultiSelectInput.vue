      ...
      >
        <div v-if="searchable" class="p-1.5 border-b border-gray-300 dark:border-carbon-800">
          <input
            ...
            v-model="query"
            type="text"
            class="w-full bg-transparent border-0 p-1 focus:ring-0 focus:outline-hidden text-base sm:text-sm text-gray-900/90 dark:text-white/90 placeholder-gray-400 dark:placeholder-wire-200/30"
